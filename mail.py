import smtplib, token

gmail_user = token.gmail_user
				...
				<tr>
				   <td>
						<table class="smallTable">
								<tr>
									<td class="minionCell"><img class="minionPicture" src="https://aix-bot.s3.amazonaws.com/mail/letterWelcome.png" alt="Greatings from minion!"></td>
									<td>
										<table class="shadow">
											<tr>
											...
											<tr>
												...
												<td class="subFooter"><a href="https://t.me/aixos_bot"><img class="footerPicture" src="https://aix-bot.s3.amazonaws.com/mail/aix3.png" alt="Greatings from minion!"></a></td>
											</tr>
										</table>
									</td>
								</tr>
		 ...
		 <table class="mainTable">
				<tr>
				   <td>
						<table class="smallTable">
								<tr>
									<td class="minionCell"><img class="minionPicture" src="https://aix-bot.s3.amazonaws.com/mail/ups.png" alt="Greatings from minion!"></td>
									<td>
										<table class="shadow">
											<tr>
											...
											<tr><td colspan="2">
												...
												<div class="code"><p><b>Token для реєстрації: AIX2019</b></p></div>
												<div class="content"><p>Повідомлення було відправлено автоматично. Якщо повідомлення надійшло вам помилково проігноруйте його.</p></div>
											</td></tr>
											<tr>
												<td><div class="content">Гарного Вам дня,<br>Віртуальний помічник викладача</div></td>
